...
% The input (and output) files can be downloaded at: https://doi.org/10.6084/m9.figshare.14061428.v3
...
%% Quality control. Always check outliers first. Very few pixels have outliers (visual inspection). Could be skipped
