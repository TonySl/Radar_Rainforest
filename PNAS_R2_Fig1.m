...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% write out the radar trends for R BFAST break point detection %%%%%%%%%%%%%%%%%%%%%%%%%%%%
save('./Americas_continent_tropical_belt_Fig1_forBFAST_Vancutsemratio95','Final_time_series_FullRadar_allpixel_average_anomaly','-v7.3')
...
CHIRPS_p_evap_allmonth=CHIRPS_data_final'-GLEAM_ET_data;   %%%% or replace GLEAM_ET_data by 100    
...
WD_time_series_CHIRPS_drought_pixels(:,min_WD_pixel<-3*std(min_WD_pixel,'omitnan'))=NaN; %%%% to exclude outlier (if any)
...
plot1=plot(Final_time_monthly_decimal,Final_time_series_FullRadar_allpixel_average_anomaly,'-','color',radar_line1,'LineWidth',1); %CT_movmean_yellow(5,:)red_light_final

hold on
%%%% 12-month moving mean
plot2=plot(Final_time_monthly_decimal,movmean(Final_time_series_FullRadar_allpixel_average_anomaly,12,'omitnan'),'-o','color',radar_line2,'LineWidth',2,'markersize',1); %%%%red_dark_final
...
ind_nan=(~isnan(Final_time_series_FullRadar_allpixel_average_anomaly));
radar_movemean=movmean(Final_time_series_FullRadar_allpixel_average_anomaly,1,'omitnan');
[c,~] = polyfit(Final_time_monthly_decimal(ind_nan),radar_movemean(ind_nan),1);
% Display evaluated equation y = m*x + b
text(1993.5,-0.2,['y = ' num2str(roundn(c(1),-4)) '*x + ' num2str(roundn(c(2),-2))],'color',radar_line1,'FontWeight','bold') 
text(1993.5,-0.27,'{\itP} < 0.001','fontweight','bold','color',radar_line1)  
...
save('./Africa_continent_tropical_belt_Fig1_forBFAST_Vancutsemratio95','Final_time_series_FullRadar_allpixel_average_anomaly','-v7.3')
...
plot(Final_time_monthly_decimal,Final_time_series_FullRadar_allpixel_average_anomaly,'-','color',radar_line1,'LineWidth',1) %CT_movmean_green(5,:)
hold on
plot(Final_time_monthly_decimal,movmean(Final_time_series_FullRadar_allpixel_average_anomaly,12,'omitnan'),'-o','color',radar_line2,'LineWidth',2,'markersize',1)
...
save('./Asia_continent_tropical_belt_Fig1_forBFAST_Vancutsemratio95','Final_time_series_FullRadar_allpixel_average_anomaly','-v7.3')
...
plot(Final_time_monthly_decimal,Final_time_series_FullRadar_allpixel_average_anomaly,'-','color',radar_line1,'LineWidth',1) %CT_movmean_blue
hold on
plot(Final_time_monthly_decimal,movmean(Final_time_series_FullRadar_allpixel_average_anomaly,12,'omitnan'),'-o','color',radar_line2,'LineWidth',2,'markersize',1)
...
ind_nan=(~isnan(Final_time_series_FullRadar_allpixel_average_anomaly));
radar_movemean=movmean(Final_time_series_FullRadar_allpixel_average_anomaly,1,'omitnan');
[c,s] = polyfit(Final_time_monthly_decimal(ind_nan),radar_movemean(ind_nan),1);
% Display evaluated equation y = m*x + b
text(1993.5,-0.2,['y = ' num2str(roundn(c(1),-4)) '*x + ' num2str(roundn(c(2),-2))],'color',radar_line1,'FontWeight','bold') 
...
ylabel_pos=ylabel('CWD (mm)','FontSize',10');
set(ylabel_pos, 'Units', 'Normalized', 'Position', [1.11, 0.796, 0]);



%%
% print(gcf,'-dtiff','-r300',strcat('./Fig1/R2/PNAS_R2_Fig1_final.tif')) 