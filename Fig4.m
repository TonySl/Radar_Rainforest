...
% All input (and output) files can be downloaded at: xxxxx
...
for i=1:size(ecoregion_drought_resistance,1)
        ...
        s1=scatter(plot_time(~idx3),plot_temp345(~idx3),scatter_size,'MarkerFaceColor',line_colors(i,:),'MarkerEdgeColor',[0.5 0.5 0.5]);  %%% shade_colors  line_colors
...
%%%% Note that the locations of the text might change on different computers

dim = [0.04+0.112-0.05 0.32+0.6 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resistance_allecoregions(1)),'*');  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(1,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);

dim = [0.04+0.165-0.05 0.32+0.6 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resistance_allecoregions(2)),'*');  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(2,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);

dim = [0.04+0.218-0.05 0.32+0.6 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resistance_allecoregions(3)),'*');  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(3,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);

dim = [0.04+0.271-0.05 0.32+0.6 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resistance_allecoregions(4)),'*');  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(4,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);
...
dim = [0.04+0.112-0.05 0.1+0.38 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resilience_allecoregions(1)),'*');  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(1,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);

dim = [0.04+0.165-0.05 0.1+0.38 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resilience_allecoregions(2)));  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(2,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);

dim = [0.04+0.218-0.05 0.1+0.38 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resilience_allecoregions(3)));  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(3,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);

dim = [0.04+0.271-0.05 0.1+0.38 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resilience_allecoregions(4)));  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(4,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);
...
dim = [0.414+0.112-0.07 0.92 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resistance_allecoregions(1)),'*');  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(1,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);

dim = [0.414+0.165-0.07 0.92 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resistance_allecoregions(2)),'*');  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(2,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);

dim = [0.414+0.218-0.07 0.92 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resistance_allecoregions(3)));  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(3,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);
...
dim = [0.414+0.112-0.07 0.48 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resilience_allecoregions(1)));  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(1,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);

dim = [0.414+0.165-0.07 0.48 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resilience_allecoregions(2)));  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(2,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);

dim = [0.414+0.218-0.07 0.48 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resilience_allecoregions(3)));  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(3,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);
...
shade_colors=brighten(line_colors,.7);


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%% time series, resistance %%%%%%%%%%%%%%%%%
all_slope_resistance_asia=[];
...
dim = [0.764+0.112-0.07 0.92 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resistance_allecoregions(1)));  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(1,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);

dim = [0.764+0.165-0.07 0.92 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resistance_allecoregions(2)),'*');  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(2,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);
...
dim = [0.764+0.112-0.07 0.48 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resilience_allecoregions(1)));  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(1,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);

dim = [0.764+0.165-0.07 0.48 0.038 0.045];
str = strcat(sprintf('%.2f',taub_resilience_allecoregions(2)));  
annotation('textbox',dim,'String',str,'BackgroundColor',line_colors(2,:),'edgecolor','none','FaceAlpha',scatter_alpha,'fontsize',9,'HorizontalAlignment','center','Margin',0.5);
...
%%
tightfig
% print(gcf,'-dtiff','-r300',strcat('./Fig4.tif'))
